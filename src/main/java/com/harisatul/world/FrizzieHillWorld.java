...
public class FrizzieHillWorld extends World {
    ...
    public FrizzieHillWorld() {
        super("FrizzieHill", 50);
    ...
    public void worldLogic() {
        ...
        System.out.println("==Welcome to FrizzieHill World==");
        System.out.println("Anda akan diberikan 4 buah karakter yang siap diluncurkan secara sekuensial");
        ...
        System.out.println("terdapat tiga babi yang telah mencuri telur anda. " +
            ...
            if (defence >= 0 ){
                ...
                for (Enemy enemy : enemies) {
                    ...
                    if (currentHealth >= 0) {
                        ...
                        currentHealth = hit;
                        enemy.setHealth(hit);
                        System.out.println("pertahanan babi " + enemy.getName() + " tersisa : " + currentHealth);
                    }
                }
        ...
        if (!enemies.isEmpty()){
            System.out.println("\nSayang sekali, Sisa Hero telah habis dan para babi belum terkalahkan");
            ...
            System.out.println("\nSelamat anda telah memenangkan pertempuran. tidak ada lagi babi yang  akan mengganggu anda");
